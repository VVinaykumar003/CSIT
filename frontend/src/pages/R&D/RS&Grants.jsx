    ...
    <div className="bg-white shadow-md rounded-md overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center px-6">
          <div>
            ...
            <p className="text-gray-200 text-sm mt-2">
              Research & Development Cell | CSIT Durg
            </p>
      ...
      <div className="py-24 px-6 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-4 text-gray-600 text-sm md:text-base max-w-xl leading-relaxed">
          The content for the{" "}
          <strong>Research Support & Grants</strong> section is currently under
          preparation and will be updated soon with information regarding
          research funding opportunities, grant schemes, financial assistance,
          sponsored projects, and support provided by the R&D Cell.
        </p>
...
export default ResearchSupportGrants;