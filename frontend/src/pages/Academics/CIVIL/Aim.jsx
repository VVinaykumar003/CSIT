      ...
      <div className="p-6">
        <div className="prose max-w-none text-gray-700">
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
              To develop abilities and talents, leading to creativity and productivity in professional and industrial field beyond the curriculum and thus enhance the employability skills.
              </li>
              <li>
              To promote lifelong self-learning abilities for gaining multi disciplinary knowledge through projects and industrial training to meet the social needs.
              </li>
              <li>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                The graduates will analyze and design regular and complex structures having acquired the knowledge of building analysis software packages.
              </li>
              <li>
