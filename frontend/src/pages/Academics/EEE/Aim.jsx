        ...
        <div className="absolute inset-0 flex items-center px-6">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-[#0d173b]">
              CSIT | Electrical and Electronics Engineering
            </h2>
      ...
      <div className="p-6">
        <div className="prose max-w-none text-gray-700">
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
              Students interpret data and understand testing, commissioning and maintenance of major electrical equipment related to power system and electrical machines.
              </li>
              <li>
              Students analyses the performance of electrical and electronic circuits and system, can evaluate the behavior and apply different control techniques for optimization.
              </li>
              <li>
