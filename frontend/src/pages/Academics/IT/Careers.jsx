...
const CareerOpportunity = () => {
  ...
  const higherStudies = [
    "Master of Technology (M.Tech) in IT",
    "Master of Business Administration (MBA)",
    "Master of Computer Application (MCA)",
    "Master of Science in IT (Abroad)."
  ];
          ...
          {activeSection === "overview" && (
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">
                Future for  Information Technology Engineering
              </h3>
              
              <div className="bg-gradient-to-r from-gray-50 to-gray-50 p-5 rounded-xl border border-gray-100">
                <p className="text-gray-700">
                Information Technology Engineering offers diverse career paths across education, government, and private sectors. Graduates can pursue advanced degrees, work in prestigious tech companies, or take on specialized technical roles that leverage their engineering skills.
                </p>
