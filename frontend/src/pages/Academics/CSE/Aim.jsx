          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                communicate at both technical and interpersonal levels.
              </li>
              <li>
                Graduates will use their understanding of professional, ethical
                and social responsibilities, the nature and background of
                diverse cultures, and the importance of life-long learning in
                the conduct of their professional careers.
              </li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                ...
                Have abilities to, analyze, design, develop and evaluate
                computer software in areas related to web based applications,
                data security, databases, algorithms, multimedia, networking and
                data communication.
              </li>
              <li>
                <span className="text-x1 font-bold text-[#0d173b]">
                ...
                Have abilities to apply standard practices and strategies in
                software project development using open-ended programming
                environments to deliver innovative quality products for business
                and societal requirement.
              </li>
              <li>
                <span className="text-x1 font-bold text-[#0d173b]">
                  {" "}
                ...
                Have ability to apply computational platforms, programming and
                logic development as computer professionals for higher studies
