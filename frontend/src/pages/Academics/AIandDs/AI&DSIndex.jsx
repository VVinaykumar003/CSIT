  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="w-full bg-[#0a1432] text-white p-8">
        <h1 className="text-4xl font-bold mb-2">Artificial Intelligence & Data Science Engineering</h1>
        <p className="text-lg">CSIT | Artificial Intelligence & Data Science Engineering</p>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="hidden md:flex border-b bg-gray-100 border-gray-200">
            {Object.keys(tabContent).map((tab) => (
              ...
              >
                <span className="text-xs lg:text-xs lg:text-base">
