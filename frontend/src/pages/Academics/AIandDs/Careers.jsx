...
const CareerOpportunity = () => {
  ...
  const higherStudies = [
    ...
    " Master in Advance Computing and many more"
  ];
          ...
          {activeSection === "overview" && (
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">
                Future for Artificial Intelligence & Data Science Engineering
              </h3>
              
              <div className="bg-gradient-to-r from-gray-50 to-gray-50 p-5 rounded-xl border border-gray-100">
                <p className="text-gray-700">
                Artificial Intelligence & Data Science Engineering offers diverse career paths across education, government, and private sectors. Graduates can pursue advanced degrees, work in prestigious tech companies, or take on specialized technical roles that leverage their engineering skills.
                </p>
